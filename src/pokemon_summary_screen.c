...
const struct CompressedSpriteSheet gSpriteSheet_MoveTypes =//const struct CompressedSpriteSheet sSpriteSheet_MoveTypes =
{
    .data = gMoveTypes_Gfx,
...
const struct SpriteTemplate gSpriteTemplate_MoveTypes =//const struct SpriteTemplate sSpriteTemplate_MoveTypes =
{
